...
sidebar_label: "Capstone - Autonomous Simulated Humanoid"
sidebar_position: 6
description: "Integration project combining all modules to create an autonomous humanoid robot in simulation"
keywords: [capstone, autonomous robot, humanoid integration, simulation, project, robotics]
---
