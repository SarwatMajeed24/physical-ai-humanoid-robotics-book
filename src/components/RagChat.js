...
const RagChat = () => {
  ...
  const sendMessage = async (useAgent = false) => {
    ...
    try {
      ...
      const endpoint = useAgent ? 'https://physical-ai-humanoid-robotics-book-jet.vercel.app/api/v1/agent/chat' : 'https://physical-ai-humanoid-robotics-book-jet.vercel.a0pp/api/v1/chat';  
